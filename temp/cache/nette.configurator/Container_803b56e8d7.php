<?php
// source: E:\src\domaci-ukoly\alert-component-example/config/common.neon
// source: E:\src\domaci-ukoly\alert-component-example/config/services.neon
// source: E:\src\domaci-ukoly\alert-component-example/config/local.neon
// source: array
...
class Container_803b56e8d7 extends Nette\DI\Container
{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'E:\src\domaci-ukoly\alert-component-example/temp/cache/nette.application/touch'
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('E:\src\domaci-ukoly\alert-component-example/temp/cache/journal.s3db');
	}
	...
	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage(
			'E:\src\domaci-ukoly\alert-component-example/temp/cache',
			$this->getService('cache.journal')
		);
	}


	public function createServiceContainer(): Container_803b56e8d7
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_803b56e8d7 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('E:\src\domaci-ukoly\alert-component-example/temp/cache/latte');
